    ...
    <div class="row stat-cards">
      <div class="col-md-6 col-xl-3">
        <article class="stat-cards-item">
          <div class="stat-cards-icon warning" style='color:white; background:#717fe09c;'>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><span class="badge-pending" style='color:white; background:#717fe09c;'><?php echo isset($comment['comment_product_id']) ? $comment['comment_product_id'] : "" ?></span></td>
