...
if (isset($_POST['pay'])) {
    ...
    if ($check == 1) {
        foreach ($_SESSION['cart'] as $key => $val) {
            $_SESSION['total'] += (int)$val['product_price'] * (int)$val['quantity'];
            $cartStr =  $val['product_name'] . "," . $val['product_price'] . "," . $val['product_id'] . "," . $val['size'] . "," . $val['quantity'] . '|';
            $cart = $cart . $cartStr;
        }
        if ($total != 0) {
                    ...
                    <form class="needs-validation" novalidate>
                        <div class="form-row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="name" class="form-control"
                                    value="<?php echo $users[0]['user_name'] ?>">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="email" name="email" class="form-control"
                                    value="<?php echo $users[0]['user_email']; ?>">
                                <div class="valid-feedback text-danger">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" name="number" class="form-control"
                                    value="<?php echo isset($users[0]['user_mobile']) ? $users[0]['user_mobile'] : ""; ?>"
                                    placeholder="Mobile">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="city" class="form-control"
                                    value="<?php echo isset($users[0]['user_location']) ? $users[0]['user_location'] : ""; ?>"
                                    placeholder="City">
                                <div class="text-danger">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input style="position:absolute; left:20px;" class="form-check-input" type="checkbox"
                    ...
                    <div class="flex-w flex-t  p-b-33">
                        <div class="size-208">
                            <span class="mtext-101 cl2">
                                Total:
                                <?php echo isset($_SESSION['total']) ?  "$" . $_SESSION['total'] : "$" . $total / 2 ?>
                            </span>
                        </div>
                    </div>
